...
public class Samsung1938_2 {
	...
	public static int dy[] = { 0, 1, 0, -1 }; // 순서대로 위오아왼

	public static Log startingPoint = null;
	public static Log destination = null;
	public static int visit[][][]; // 0 = 통나무가 0방향일때
	...
	public static void main(String[] args) throws IOException {
		...
		//시작점 도착점을 찾아보자. 처음 발견한 점 기준 오른쪽으로 있으면 - 아래로 있으면 |
		for (int i = 0; i <N; i++) {
			for (int j = 0; j < N; j++) {
				if (map[i][j]=='B') { //출발 
					for (int k = 1; k <= 2; k++) {
...
//			}
	...
	public static boolean canIMoveTheLog(Log now, int direction) { // 여기ㅣ서 direction은 위오아왼 순의 숫자.
		// status of the log
